        ...
        {dashboard.data && !dashboard.isLoading && (
          <>
            ...
            <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5" aria-label="Pendências e ações">
              ...
              <article className="rounded-2xl border border-l-4 ui-border ui-surface p-4 [border-left-color:#A89BC8]"><p className="text-sm font-bold ui-text-muted">Folgas pendentes</p><p className="mt-2 text-2xl font-extrabold ui-text">{dashboard.data.pendingTimeOffRequests}</p></article>
