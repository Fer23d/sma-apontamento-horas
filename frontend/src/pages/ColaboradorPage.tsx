...
export function ColaboradorPage() {
  ...
  function openDateWorkflow(date: string, hasEntries: boolean) {
    if (hasEntries) {
      navigate(`/colaborador/historico?date=${date}`)
      return
    }
    navigate(`/colaborador/apontamentos/novo?date=${date}`)
  }
